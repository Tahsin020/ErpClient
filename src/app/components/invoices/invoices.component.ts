...
@Component({
  ...
  standalone: true,
  imports: [SharedModule,InvoicePipe,RouterLink],
  providers: [DatePipe],
...
export class InvoicesComponent implements OnInit {
  ...
  constructor(private http: HttpService, private swal: SwalService, private date: DatePipe, private activated:ActivatedRoute) {
  ...
  deleteById(model:InvoiceModel){
    this.swal.callSwal("Faturayı Sil?",`${model.customer.name} - ${model.invoiceNumber} numaralı siparişi silmek istiyor musunuz?`,() => {
